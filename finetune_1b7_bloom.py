...
#pruned_model = BloomForCausalLM.from_pretrained(f"bigscience/bloom-{model_size}")
pruned_model = torch.load("../models/pruned_30percent_1b7_bloom_full.pt")
...
torch.save(finetuned_model, "finetuned_30percent_pruned_bloom1b7.pt")
