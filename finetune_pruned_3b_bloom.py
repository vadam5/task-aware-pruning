...
# Load model
weights_path = "../models/pruned_50percent_3B_bloom.pt"
state_dict_shapes_path = "../models/pruned_50percent_3B_bloom_state_dict_shapes.pkl"
...
pruned_model = BloomForCausalLM(bloom_config)
